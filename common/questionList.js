export default [{
	...
	question: '工作绩效数据',
	imgSrc: require('../static/answer/15.png'),
	...
	question: 'SWOT',
	imgSrc: require('../static/answer/16.png'),
	...
	question: '概率和影响评估矩阵',
	imgSrc: require('../static/answer/17.png'),
	answerText: ['高风险威胁（采取积极应对策略）','高风险机会（工作重心）','低风险威胁（分配应急储备）','低风险机会（持续监控）']
}, {
	question: '合同类型的选择',
	answerText: ['总价合同','-- 范围清楚','-- 卖方承担风险','----------------------------','成本补偿合同','-- 范围不清楚','-- 买方承担风险','----------------------------','工料合同','-- 范围明确','-- 工作量无法估计','----------------------------','订购单','-- 范围明确','-- 非大量采购标准化产品','----------------------------']
}]
